...
//   Last Modified : Nov. 14 10:22 EST 2013
//
...
int verify_line( char *master, char *student ) {
  char *master_out, *student_out, *master_cycle_out, *stud_cycle_out; 
  int cmp;
  ...
  // output.
  master_cycle_out = strstr( master, CYCLE_TOK );
  stud_cycle_out = strstr( student, CYCLE_TOK );
